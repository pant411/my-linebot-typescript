...
var CovidData_1 = require("./CovidData");
var app = express;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log(event);
                    text_req = event.message.text;
                    if (event.type !== 'message' || event.message.type !== 'text') {
                        return [2 /*return*/, Promise.resolve(null)];
                    }
                    if (!(text_req.includes("โควิด") || text_req.toLowerCase().includes("covid"))) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, CovidData_1["default"])()];
                case 1:
                    _covid = _a.sent();
                ...
                case 2: return [2 /*return*/, client.replyMessage(event.replyToken, {
                        "type": 'text',
                        "text": text_req
                    })];
            }
